...
RAM(2) <= "00000010000000000000010100000110"; --Byte '1'
RAM(3) <= "00000010000000000000011100001000"; --Byte '1'
RAM(4) <= "00000010000000000000100100001010"; --Byte '1'
RAM(5) <= "00000010000000000000101100001100"; --Byte '1'
RAM(6) <= "00000010000000000000110100001110"; --Byte '1'
RAM(7) <= "00000010000000000000111100010000"; --Byte '1'
RAM(8) <= "00000010000000000001000100010010"; --Byte '1'
RAM(9) <= "00000010000000000001001100010100"; --Byte '1'
RAM(10) <= "00000010000000000000000100000010";
RAM(11) <= "00000010000000000000001100000100"; --Byte '1'
RAM(12) <= "00000010000000000000010100000110"; --Byte '1'
RAM(13) <= "00000010000000000000011100001000"; --Byte '1'
RAM(14) <= "00000010000000000000100100001010"; --Byte '1'
RAM(15) <= "00000010000000000000101100001100"; --Byte '1'
RAM(16) <= "00000010000000000000110100001110"; --Byte '1'
RAM(17) <= "00000010000000000000111100010000"; --Byte '1'
